    ...
    public class SurveyController {
        ...
        static ArrayList<QuestionAndAnswers> surveys = new ArrayList<>();
        ...
        public static void createSurvey() {
            ...
            if (GlobalFunctions.createConfirmMenu("Do you want to save this survey?")) {
                ...
                surveys.add(survey);
                writeSurveysToFile(surveys, gameName);
        ...
        public static void writeSurveysToFile(ArrayList<QuestionAndAnswers> surveys, String gameName) {
            StringBuilder stringBuilder = new StringBuilder();

            for (QuestionAndAnswers survey : surveys) {
                stringBuilder.append("Game Name: ").append(gameName).append("\n");
                stringBuilder.append("Question: ").append(survey.getQuestion()).append("\n");
                stringBuilder.append("Multiple Choice: ").append(survey.isMultipleChoice()).append("\n");

                if (survey.isMultipleChoice()) {
                    stringBuilder.append("### Choices ###\n");
                    ArrayList<String> choices = survey.getChoices();
                    for (String choice : choices) {
                        stringBuilder.append("- ").append(choice).append("\n");
                    }
                    stringBuilder.append("### End of Choices ###\n");
                }
                ...
                if (!answers.isEmpty()) {
                    ...
                    stringBuilder.append("### End of Answers ###\n");
                }
